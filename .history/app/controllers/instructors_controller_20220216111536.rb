class InstructorsController < ApplicationController
  ...
  def update
    ...
    user_params = { "user_type" => "instructor", "email" => 'harinibharata@gmail.com',
                    ...
                    "password_confirmation" => instructor_params["password_confirmation"]}
    respond_to do |format|
      if @user.update(user_params)  && @instructor.update(instructor_params)
  ...
  private
    ...
    # Only allow a list of trusted parameters through.
    def user_params
      params.require(:user).permit(:name, :date_of_birth, :phone_number, :major, :department, :user_type, :email, :password, :password_confirmation)
    end
end
